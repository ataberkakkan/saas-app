...
```bash
git clone https://github.com/ataberkakkan/saas-app.git
cd saas-app
```
...
Replace the placeholder values with your actual [Supabase](https://supabase.com/dashboard), [Clerk](https://clerk.com), [Sentry](https://sentry.io) and [Vapi](https://vapi.ai/) credentials.
